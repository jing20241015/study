...
def main():
    ...
    opt['input_folder'] = './datasets/GOPRO_Large/train/GOPR0372_07_00'
    opt['save_folder'] = './datasets/GOPRO_Large/train/GOPR0372_07_00/blur_crops'
    opt['crop_size'] = 512
    opt['step'] = 256
    opt['thresh_size'] = 0
    ...
    opt['input_folder'] = './datasets/GOPRO_Large/train/GOPR0372_07_00'
    opt['save_folder'] = './datasets/GOPRO_Large/train/GOPR0372_07_00/sharp_crops'
    opt['crop_size'] = 512
    opt['step'] = 256
    opt['thresh_size'] = 0
    extract_subimages(opt)
